...
───────────────
ikupaca
  E-mail : ikupaca@gmail.com
  Home Page: http://ikupaca.chobi.net/index.php
...
【Facebook】
    Team ikupaca
    https://www.facebook.com/ikupaca
───────────────
...
<?php echo $errm; ?><br /><br /><input  class="redButton" type="button" value=" 前画面に戻る " onClick="history.back()">
</div>
<?php }else{ ?>
<h3>確認画面</h3>
...
<p align="center">
<input class="redButton" type="button" value="前画面に戻る" onClick="history.back()"></p>
</form>
</main>
<?php } ?>
</div><!-- /formWrap -->
...
<p><input class="redButton" type="button" onclick="location.href='./index.php'" value="戻る"></p>
</main></div>
</body>
</html>
<?php 
